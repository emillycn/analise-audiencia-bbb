...
# 2. DADOS SIMULADOS (Ato 3: Ressaca de Grade)
...
# Aumentamos o top para 0.72 para dar um "respiro" generoso para os títulos
...
# 6. TÍTULOS (Ajuste de Y para não bater na legenda)
...
# 7. LEGENDA CENTRALIZADA (Evita o canto congestionado do título)
...
# Removido tight_layout() pois ele conflita com ajustes manuais de suptitle/subplots_adjust
