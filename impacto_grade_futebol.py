...
fig, ax = plt.subplots(figsize=(12, 7.5)) # Aumentamos levemente a altura
...
# 5. A SOLUÇÃO DA LEGENDA (Horizontal e Centralizada)
...
# 6. ANOTAÇÃO (Posicionada em área de respiro)
